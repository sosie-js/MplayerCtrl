...
#https://pythonhosted.org/MplayerCtrl/tutorial.html
#https://pypi.org/project/MplayerCtrl/
...
#2to3 -w MplayerCtrl.py
import MplayerCtrl as mpc
print("Using Mpc "+mpc.__version__)
import wx.lib.buttons as buttons

dirName = os.path.dirname(os.path.abspath(__file__))
bitmapDir = os.path.join(dirName, 'bitmaps/player')
...
class Frame(wx.Frame):
    ...
    def create_menu(self):
        ...
        menubar = wx.MenuBar()
        fileMenu = wx.Menu()
       #wx.NewId() is Deprecated since wxpython >=4.0.2, it is wx.NewIdRef() 
        add_file_menu_item = fileMenu.Append(wx.NewIdRef(), "&Add File", "Add Media File")
    ...
    def on_add_file(self, event):
        ...
        dlg = wx.FileDialog(
            ...
            defaultDir=self.currentFolder,  #os.getcwd(),
            defaultFile="",
            wildcard=wildcard,
            style=wx.FD_OPEN | wx.FD_CHANGE_DIR | wx.FD_FILE_MUST_EXIST |
                  wx.FD_PREVIEW #  wx.OPEN ; wx.CHANGE_DIR in python2.
            )
